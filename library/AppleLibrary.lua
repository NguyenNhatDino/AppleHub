do local GUI = game.CoreGui:FindFirstChild("Apple Hub");if GUI then GUI:Destroy();end;if _G.Color == Color3.fromRGB(255, 0, 4) then
...
function Update:Window(text,logo,keybind)
 ...
 local APPLEHUB = Instance.new("ScreenGui")
 APPLEHUB.Name = "Apple Hub"
 APPLEHUB.Parent = game.CoreGui
 APPLEHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
 
 local Main = Instance.new("ImageLabel")
 Main.Name = "Main"
 Main.Parent = APPLEHUB
...
game:GetService("RunService").RenderStepped:Wait()
 ...
 function uitab:Tab(text,icon)
	 ...
	 function main:Button(text,callback)
		 ...
		 TextBtn.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
...
person.ImageRectSize = Vector2.new(36, 36)
	 ...
	 function main:Slider(text,min,max,set,callback)
		 ...
		 Slider.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
		 ...
		 HAHA.Name = "HAHA"
		 HAHA.Parent = sliderr
		 HAHA.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
		 ...
		 bar1.Name = "bar1"
		 bar1.Parent = bar
		 bar1.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
		 ...
		 slidervalue.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
	 ...
	 function main:Seperator(text)
		 ...
		 Sep1.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
		 ...
		 Sep3.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
	 ...
	 function main:Line()
		 ...
		 Linee.BackgroundColor3 = Color3.fromRGB(255, 0, 4)
